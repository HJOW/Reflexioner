...
public class ReflexReplayPlayer extends MouseDragCatcher implements ActionListener, Openable, Runnable
{
    ...
    public void init()
    {
        ...
        titleLabel = new JLabel(sets.trans("Replay"));
        ...
        menu_file_play = new JMenuItem(sets.trans("Play"));
        ...
        menu_file_play.setBackground(sets.getColor("ColorSelectedInsideBack"));
        menu_file_play.setForeground(sets.getColor("ColorSelectedFore"));
        if(Reflexioner.usingFont != null)
        {
        ...
        menu_file_speed.setBackground(sets.getColor("ColorSelectedInsideBack"));
        menu_file_speed.setForeground(sets.getColor("ColorSelectedFore"));
        if(Reflexioner.usingFont != null)
        {
        ...
        {
            menu_file_speed.setText(sets.trans("Speed"));
        }
        ...
        menu_file_load.setBackground(sets.getColor("ColorSelectedInsideBack"));
        ...
        menu_file_continue.setBackground(sets.getColor("ColorSelectedInsideBack"));
        menu_file_continue.setForeground(sets.getColor("ColorSelectedFore"));
        if(Reflexioner.usingFont != null)
        {
        ...
        if(sets.get("Language").equals("ko"))
        {
            menu_file_continue.setText("이어서 " + sets.trans("Start"));
        }
        else            
        {
            menu_file_continue.setText("Continue, " + sets.trans("Start"));
        }
        ...
        menu_file_exit.setBackground(sets.getColor("ColorSelectedInsideBack"));
        ...
        menu_view_status = new JMenuItem(sets.trans("Detail"));
        ...
        menu_view_status.setBackground(sets.getColor("ColorSelectedInsideBack"));
        menu_view_status.setForeground(sets.getColor("ColorSelectedFore"));
        if(Reflexioner.usingFont != null)
        {
        ...
        replayCanvas.loadBackground(sets.getDefaultPath());
        ...
        if(sets.getColor("ColorSelectedButton") != null)
            bt_play.setBackground(sets.getColor("ColorSelectedButton"));
        ...
        if(sets.getColor("ColorSelectedButton") != null)
            bt_stop.setBackground(sets.getColor("ColorSelectedButton"));
        bt_stop.setForeground(sets.getColor("ColorSelectedFore"));
        if(Reflexioner.usingFont != null)
            bt_stop.setFont(Reflexioner.usingFont);
        downPanel.add(bt_stop);
        
        bt_detail = new JButton(sets.trans("Detail"));
        bt_detail.addActionListener(this);
        if(sets.getColor("ColorSelectedButton") != null)
            bt_detail.setBackground(sets.getColor("ColorSelectedButton"));
        bt_detail.setForeground(sets.getColor("ColorSelectedFore"));
        if(Reflexioner.usingFont != null)
            bt_detail.setFont(Reflexioner.usingFont);
        
        statusPanel = new JPanel();
        statusPanel.setBackground(sets.getColor("ColorSelectedBack"));
        ...
        progressLabel = new JLabel(sets.trans("Run"));
        ...
        progressField.setForeground(sets.getColor("ColorSelectedFore"));
        pointField.setBackground(sets.getColor("ColorSelectedInsideBack"));
        progressField.setBackground(sets.getColor("ColorSelectedInsideBack"));
        playSpeedField.setForeground(sets.getColor("ColorSelectedFore"));
        playSpeedField.setBackground(sets.getColor("ColorSelectedInsideBack"));
        if(Reflexioner.usingFont != null)
        {
        ...
        authCheck = new JCheckBox(sets.trans("Authority"));
        ...
        authCheck.setForeground(sets.getColor("ColorSelectedFore"));
        authCheck.setBackground(sets.getColor("ColorSelectedBack"));
        if(Reflexioner.usingFont != null)
        {
        ...
        statusDialog_mainPanel.setBackground(sets.getColor("ColorSelectedBack"));
        ...
        status_upPanel.setBackground(sets.getColor("ColorSelectedBack"));
        status_downPanel.setBackground(sets.getColor("ColorSelectedBack"));
        status_centerPanel.setBackground(sets.getColor("ColorSelectedBack"));
        ...
        status_titleLabel = new JLabel(sets.trans("Detail"));
        status_titlePanel = new JPanel();
        status_titlePanel.setBorder(new EtchedBorder());
        status_titlePanel.setBackground(sets.getColor("ColorSelectedInsideBack"));
        status_titleLabel.setForeground(sets.getColor("ColorSelectedFore"));
        if(Reflexioner.usingFont != null)
        ...
        bt_status_close = new JButton("X");
        bt_status_close.addActionListener(this);
        if(sets.getColor("ColorSelectedButton") != null)
            bt_status_close.setBackground(sets.getColor("ColorSelectedButton"));
        bt_status_close.setForeground(sets.getColor("ColorSelectedFore"));
        if(Reflexioner.usingFont != null)
        ...
        statusArea.setBackground(sets.getColor("ColorSelectedInsideBack"));
        statusArea.setForeground(sets.getColor("ColorSelectedFore"));        
        if(Reflexioner.usingFont != null)
            statusArea.setFont(Reflexioner.usingFont);
        statusArea2 = new JTextArea();
        statusArea2.setEditable(false);
        statusArea2.setBackground(sets.getColor("ColorSelectedInsideBack"));
        statusArea2.setForeground(sets.getColor("ColorSelectedFore"));        
        if(Reflexioner.usingFont != null)
        ...
        status_authField.setBackground(sets.getColor("ColorSelectedInsideBack"));
        status_authField.setForeground(sets.getColor("ColorSelectedFore"));        
        if(Reflexioner.usingFont != null)
        ...
        status_spinPanel.setBackground(sets.getColor("ColorSelectedBack"));
        status_spinPanel.setForeground(sets.getColor("ColorSelectedFore"));        
        ...
        loading_centerPanel.setBackground(sets.getColor("ColorSelectedBack"));
        loading_eastPanel.setBackground(sets.getColor("ColorSelectedBack"));
        loading_centerPanel.setLayout(new FlowLayout());
        loading_eastPanel.setLayout(new FlowLayout());
        loading_centerLabel = new JLabel(sets.trans("Load") + "...");
        loading_centerLabel.setForeground(sets.getColor("ColorSelectedFore"));
        if(Reflexioner.usingFont != null)
            loading_centerLabel.setFont(Reflexioner.usingFont);
        loading_centerPanel.add(loading_centerLabel);
        bt_loading_cancel = new JButton("X");
        bt_loading_cancel.addActionListener(this);
        bt_loading_cancel.setForeground(sets.getColor("ColorSelectedFore"));
        if(sets.getColor("ColorSelectedButton") != null) bt_loading_cancel.setBackground(sets.getColor("ColorSelectedButton"));
        if(Reflexioner.usingFont != null)
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if(ob == menu_file_speed)
        {
            ...
            {
                JOptionPane.showMessageDialog(window, sets.trans("Error") + " : " + e1.getMessage());
            }
        }
            ...
            if(playing && playing_replay != null)
            {
                ...
                try
                {
                    if(nowDraw.getAutoControl() != null && nowDraw.getAutoControl().booleanValue())
                    {
                        ...
                        g.drawString(sets.trans("AI"), 5, 15);
                    }
                }
                catch(Exception e)
                {
            ...
            if(playing_replay != null)
            {
                try
                {
                    if(progress >= playing_replay.getScenes().size())
                    {
                        ...
                        if(playing_replay.getName() != null) finishMessages.add(sets.trans("Name") + " : " + playing_replay.getName());
                        if(playing_replay instanceof AReflexReplay)
                        {
                            AReflexReplay playing_ar = (AReflexReplay) playing_replay;
                            if(playing_ar.getFinal_point() != null) finishMessages.add(sets.trans("Point") + " : " + playing_ar.getFinal_point().toString());
                            
                        }                        
                        try
                        {
                            finishMessages.add("");
                            finishMessages.add(sets.trans("Reflexioner") + " v" + new DetailedVersionData().toString());
                        } 
                        catch (Exception e)
                        {
                            e.printStackTrace();
                        ...
                        if(playing_replay instanceof BReflexReplay)
                        {
                            ...
                            else showReplayTitle = sets.trans("Complete");
                        }
                        else showReplayTitle = sets.trans("Complete");
    ...
    private void loadCore(File file) throws Exception
    {
        ...
        try
        {
            ...
            {
                s.loadImages(sets.getDefaultPath());
            }
        }
        catch(Exception e)
        {
    ...
    private void loadReplay()
    {
        ...
        {
            JOptionPane.showMessageDialog(window, sets.trans("Error") + " : " + e.getMessage());
            e.printStackTrace();
        }
        finally
        {
    ...
    private void status_refresh()
    {
        ...
        try
        {
            ...
            results = results.append("" + sets.trans("HP") + " \t: "); results = results.append(String.valueOf(nowDraw.getSpaceShip().getHp())); results = results.append(" / ");
            ...
            results = results.append(sets.trans("HP") + " Heal \t: "); results = results.append(String.valueOf(nowDraw.getSpaceShip().getHp_heal())); results = results.append("\n");
        ...
        try
        {
            ...
            results2 = results2.append("\nEnemies\nType\t");
            results2 = results2.append(sets.trans("HP"));
