...
public class Korean implements Language
{
    ...
    public Korean()
    {
        ...
        prop.setProperty("Replay Interval"                                                                                         , "리플레이 간격"                                                                                           );
        ...
        prop.setProperty("Files will be located at"                                                                                , "다음 폴더에 파일이 생성됩니다. "                                                                         );
        ...
        prop.setProperty("Asset files information (Written in Korean)"                                                             , "에셋 파일 정보"                                                                                          );
