...
public class UserDefinedLang extends English
{
	...
	public UserDefinedLang()
	{
		super();
	}
	public UserDefinedLang(String contents)
	{
		super();
	...
	{
		return new UserDefinedLang(str);
	}
	...
	{
		UserDefinedLang newOne = new UserDefinedLang(new String(this.languagePackage));
